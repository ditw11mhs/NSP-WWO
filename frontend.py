...
class Main:
    ...
    def input(self):
        ...
        with st.sidebar.form("Input"):
            ...
            st.number_input("H Max (Max Wave Height)", key="hmax", value=6,step=0.000001)
            st.number_input("Lambda (Wavelength)", key="lambd", value=0.5,step=0.000001)
            st.number_input("Alpha", key="alpha", value=1.001,step=0.000001)
            st.number_input("Beta Max", key="beta_max", value=0.01,step=0.000001)
            st.number_input("Beta Min", key="beta_min", value=0.001,step=0.000001)
