...
class Main:
    ...
    def input(self):
        ...
        with st.sidebar.form("Input"):
            ...
            st.number_input("H Max (Max Wave Height)", key="hmax", value=6)
            st.number_input("Lambda (Wavelength)", key="lambd", value=0.5)
            st.number_input("Alpha", key="alpha", value=1.001)
            st.number_input("Beta Max", key="beta_max", value=0.01)
            st.number_input("Beta Min", key="beta_min", value=0.001)
